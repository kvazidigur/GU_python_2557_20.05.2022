...
class Warehouse:
    ...
    def add_equipment(self, equipment, inventory_number):
        ...
        self._dict[equipment.inventory_number] = equipment

    def transfer(self, inventory_number, department):
        try:
            self._dict[inventory_number].department = department
        except KeyError:
            print(f'Оборудования с иинв. номером: {inventory_number} - нет на складе.')
...
wh.transfer('1234', 'Офис')
wh.transfer('2222', 'Офис')
